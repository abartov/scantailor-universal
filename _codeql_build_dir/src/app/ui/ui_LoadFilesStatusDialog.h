...
public:
    ...
    {
        LoadFilesStatusDialog->setWindowTitle(QCoreApplication::translate("LoadFilesStatusDialog", "Some files failed to load", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(loadedTab), QCoreApplication::translate("LoadFilesStatusDialog", "Loaded successfully: %1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(failedTab), QCoreApplication::translate("LoadFilesStatusDialog", "Failed to load: %1", nullptr));
    } // retranslateUi
