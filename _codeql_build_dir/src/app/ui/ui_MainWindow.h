...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCopySourceFileName->setIcon(icon2);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/keep-in-view.png"), QSize(), QIcon::Normal, QIcon::Off);
        focusButton->setIcon(icon3);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/multi_choice.png"), QSize(), QIcon::Normal, QIcon::Off);
        multiselectButton->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/gimp-reset.png"), QSize(), QIcon::Normal, QIcon::Off);
        resetSortingBtn->setIcon(icon5);
