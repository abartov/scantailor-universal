...
"font-weight: bold;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 448, 220));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 434, 266));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 448, 220));
...
"font-weight: bold;"));
    ...
    {
        OutOfMemoryDialog->setWindowTitle(QCoreApplication::translate("OutOfMemoryDialog", "Out of memory", nullptr));
        label->setText(QCoreApplication::translate("OutOfMemoryDialog", "Out of Memory Situation in Scan Tailor", nullptr));
        label_4->setText(QCoreApplication::translate("OutOfMemoryDialog", "Did you have to fix the DPI of your source images? Are you sure the values you entered were correct?", nullptr));
        label_6->setText(QCoreApplication::translate("OutOfMemoryDialog", "Sometimes your source images may have wrong DPI embedded into them. Scan Tailor tries to detect those, but it's not always easy to tell. You may need to check \"Fix DPI even if they look normal\" when creating a project and look into \"All pages\" tab in the \"Fix DPI\" dialog, which is also accessible from the Tools menu.", nullptr));
        label_8->setText(QCoreApplication::translate("OutOfMemoryDialog", "Is your output DPI set too high? Usually you don't need it higher than 600.", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("OutOfMemoryDialog", "Possible reasons", nullptr));
        label_10->setText(QCoreApplication::translate("OutOfMemoryDialog", "Fix your DPIs. Learn how to <a href=\"http://vimeo.com/12524529\">estimate unknown DPIs</a>.", nullptr));
        only_32bit_1->setText(QCoreApplication::translate("OutOfMemoryDialog", "If your hardware and operating system are 64-bit capable, consider switching to a 64-bit version of Scan Tailor.", nullptr));
        label_12->setText(QCoreApplication::translate("OutOfMemoryDialog", "When working with grayscale images, make sure they are really grayscale. If they are actually color images that just happen to look grayscale, convert them to grayscale using some kind of batch image converter. This will both save memory and increase performance.", nullptr));
        label_14->setText(QCoreApplication::translate("OutOfMemoryDialog", "As a last resort, you can save some memory by making sure thumbnails are pre-created rather than created on demand. This can be done by slowly scrolling the thumbnail list all the way from top to bottom before starting any real work.", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("OutOfMemoryDialog", "What can help", nullptr));
        label_5->setText(QCoreApplication::translate("OutOfMemoryDialog", "Surprisingly, upgrading your RAM won't help here. The lack of RAM is compensated by the swap mechanism, which makes things slow, but keeps programs running. An out of memory situation means we ran out of memory address space, which has nothing to do with the amount of RAM you have. The only way to increase the memory address space is to go 64-bit hardware, 64-bit operating system and 64-bit Scan Tailor.", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("OutOfMemoryDialog", "What won't help", nullptr));
        saveProjectBtn->setText(QCoreApplication::translate("OutOfMemoryDialog", "Save Project", nullptr));
        saveProjectAsBtn->setText(QCoreApplication::translate("OutOfMemoryDialog", "Save Project As...", nullptr));
        dontSaveBtn->setText(QCoreApplication::translate("OutOfMemoryDialog", "Don't Save", nullptr));
        label_2->setText(QCoreApplication::translate("OutOfMemoryDialog", "Project Saved Successfully", nullptr));
        label_3->setText(QCoreApplication::translate("OutOfMemoryDialog", "Please note that while Scan Tailor tries to catch out-of-memory situations and give you the opportunity to save your project, it's not always possible. This time it succeeded, but the next time it might just crash.", nullptr));
    } // retranslateUi
