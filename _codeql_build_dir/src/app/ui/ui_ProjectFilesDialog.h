...
public:
    ...
    {
        ProjectFilesDialog->setWindowTitle(QCoreApplication::translate("ProjectFilesDialog", "Project Files", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("ProjectFilesDialog", "Input Directory", nullptr));
        inpDirBrowseBtn->setText(QCoreApplication::translate("ProjectFilesDialog", "Browse", nullptr));
        groupBox->setTitle(QCoreApplication::translate("ProjectFilesDialog", "Output Directory", nullptr));
        outDirBrowseBtn->setText(QCoreApplication::translate("ProjectFilesDialog", "Browse", nullptr));
        groupBox_3->setTitle(QCoreApplication::translate("ProjectFilesDialog", "Files Not In Project", nullptr));
        offProjectSelectAllBtn->setText(QCoreApplication::translate("ProjectFilesDialog", "Select All", nullptr));
#if QT_CONFIG(tooltip)
        addToProjectBtn->setToolTip(QCoreApplication::translate("ProjectFilesDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Add selected files to project.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        addToProjectBtn->setText(QCoreApplication::translate("ProjectFilesDialog", ">>", nullptr));
#if QT_CONFIG(tooltip)
        removeFromProjectBtn->setToolTip(QCoreApplication::translate("ProjectFilesDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal;\">\n"
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Remove selected files from project.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        removeFromProjectBtn->setText(QCoreApplication::translate("ProjectFilesDialog", "<<", nullptr));
        groupBox_4->setTitle(QCoreApplication::translate("ProjectFilesDialog", "Files In Project", nullptr));
        inProjectSelectAllBtn->setText(QCoreApplication::translate("ProjectFilesDialog", "Select All", nullptr));
        rtlLayoutCB->setText(QCoreApplication::translate("ProjectFilesDialog", "Right to left layout (for Hebrew and Arabic)", nullptr));
        forceFixDpi->setText(QCoreApplication::translate("ProjectFilesDialog", "Fix DPIs, even if they look OK", nullptr));
    } // retranslateUi
