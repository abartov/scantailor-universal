...
#include <memory>
#include "../../../../../src/core/WorkerThread.h"
...
QT_MOC_LITERAL(1, 13, 10), // "taskResult"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 17), // "BackgroundTaskPtr"
QT_MOC_LITERAL(4, 43, 4), // "task"
QT_MOC_LITERAL(5, 48, 15), // "FilterResultPtr"
QT_MOC_LITERAL(6, 64, 6), // "result"
QT_MOC_LITERAL(7, 71, 11) // "performTask"

    },
    "WorkerThread\0taskResult\0\0BackgroundTaskPtr\0"
    "task\0FilterResultPtr\0result\0performTask"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->taskResult((*reinterpret_cast< const BackgroundTaskPtr(*)>(_a[1])),(*reinterpret_cast< const FilterResultPtr(*)>(_a[2]))); break;
        case 1: _t->performTask((*reinterpret_cast< const BackgroundTaskPtr(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkerThread::*)(BackgroundTaskPtr const & , FilterResultPtr const & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::taskResult)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::taskResult(BackgroundTaskPtr const & _t1, FilterResultPtr const & _t2)
{
